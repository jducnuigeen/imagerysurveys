...
site_url = "http://imagerysurveys-test.readthedocs.io/en/latest/"
...
project = u'NZ Imagery Surveys Data Dictionary'
...
html_title = 'NZ Imagery Surveys Data Dictionary'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'NZ Imagery Surveys Data Dictionary'
...
htmlhelp_basename = 'NZ_Imagery_Surveys'
...
man_pages = [
    (master_doc, 'nz_imagery_surveys_data_dictionary', u'nz_imagery_surveys_data_dictionary',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nz_imagery_surveys_data_dictionary', u'NZ Imagery Surveys Data Dictionary',
     author, 'LINZ', 'Documentation for the NZ Imagery Surveys Dataset',
     'Miscellaneous'),
]
        ...
        if "foreign key to the" in column_comment_result_clean_lower:
            ...
            if foreign_search is not None:
                ...
                if schema_check == "buildings" or schema_check == "buildings_common" or schema_check == "buildings_bulk_load":
                    template_url = "`{schema_table} <https://imagerysurveys-test.readthedocs.io/en/latest/internal_data.html#table-{table_name_hyphens}>`_"
...
def get_columns(table_str, file_content, this_table_columns):
    ...
    for column_details in columns_strip:
        print "column comment: ", column_details
